package com.donny.shortlink.project.mq.consumer;
...
import com.donny.shortlink.project.mq.idempotent.MessageQueueIdempotentHandler;
...
import static com.donny.shortlink.project.common.constant.ShortLinkConstant.AMAP_REMOTE_URL;
...
//    private final StringRedisTemplate stringRedisTemplate;
    ...
    public void onMessage(Map<String, String> producerMap) {
        ...
        if (!messageQueueIdempotentHandler.isMessageProcessed(keys)) {
            ...
            throw new ServiceException("MQ消息未完成流程, 需要消息队列重试");
        }
        try {
...
//    }
    ...
    public void actualSaveShortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        // TODO 生产者消息不传递gid, 为了避免并发下gid被修改后消息队列传递的是修改前的gid导致数据错乱, 让消费者的执行逻辑中去数据库获取最新的gid
        // TODO 这种写法不会对数据库造成压力，因为消息队列削峰保证了是异步顺序执行
